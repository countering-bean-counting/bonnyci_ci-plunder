...
ggplot(data = all_repo_updated_freq, 
       aes(x = factor(updated_since_days_max), 
           y = num_repos,
...
```{r}
all_repo_languages_freq <- readRDS("all_repo_languages_freq.rds")

all_repo_languages_freq$language <- factor(all_repo_languages_freq$language, levels = 
                                             all_repo_languages_freq$language[
                                               order(all_repo_languages_freq$num_repos, decreasing=TRUE)])

ggplot(data = all_repo_languages_freq, 
       aes(x = language, 
           y = num_repos,
           fill = language)) +
  geom_bar(stat="identity") +
...
ggsave("all_repo_languages_freq.png")
```

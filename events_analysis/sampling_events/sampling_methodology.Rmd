...
all_repo_languages_pct_freq_top$language <- 
  factor(all_repo_languages_pct_freq_top$language, 
         levels = unique(all_repo_languages_pct_freq_top$language[
           order(all_repo_languages_pct_freq_top$total_repos, decreasing=TRUE)]))

...
```{r}
all_repo_languages_freq_sql <-
  'select * from [bonnyci-github-archive:ci_plunder_repo_samples_all.repo_languages_freq]'

all_repo_languages_freq <- query_exec(all_repo_languages_freq_sql, project = project)

saveRDS(all_repo_languages_freq, "all_repo_languages_freq.rds")

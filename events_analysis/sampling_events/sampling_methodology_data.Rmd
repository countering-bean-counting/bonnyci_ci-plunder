...
```{r}
create_events_repo_summary_sql <-
  'select * from [bonnyci-github-archive:ci_plunder_repo_samples_create.ghevents_repo_summary]'

create_events_repo_summary <- query_exec(create_events_repo_summary_sql, project = project)

saveRDS(create_events_repo_summary, "create_events_repo_summary.rds")

```

```{r}
create_events_repo_type_summary_sql <-
  'select * from [bonnyci-github-archive:ci_plunder_repo_samples_create.ghevents_repo_type_summary]'

create_events_repo_type_summary <- query_exec(create_events_repo_type_summary_sql, project = project)

saveRDS(create_events_repo_type_summary, "create_events_repo_type_summary.rds")
